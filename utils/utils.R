...
request = function (geometry, model, crop_type, interval, year) {
    ...
    response = POST(
        ...
        body = list(
            ...
            end_date = end_date,
            interval = interval,
            geometry = list(-121.34772777557373,38.336472428721294,-121.35154724121094,38.33633778055649,-121.35159015655519,38.33270218552158,-121.3453245162964,38.3325675303505,-121.34781360626222,38.33475564587652),
            model = tolower(model),
            variable = 'et',
